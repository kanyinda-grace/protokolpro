...
if (isset($_POST['sub'])) {
    extract($_POST);
    $ps=$bdd->prepare("INSERT INTO fonction(nom_fonction) VALUES (?)");
...
<head>
  ...
  <button id="close">Fermer</button>
    ...
    <div class="bloc-login">
        ...
        <br><br>
        <span class="title-msg">Ajouter une fonction !</span>
        <?php if(isset($msg)) { ?><br><br><p class="msg-error"><i class="fa fa-exclamation-triangle"></i> <?php echo $msg; ?></p><?php } ?>
         <br><input style="margin-top:20px" type="text" name="sub" placeholder="Fonction">
         <br>
