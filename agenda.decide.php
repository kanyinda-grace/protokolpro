...
<head>
 ...
 <header>
   ...
   <br><button name="maj" type="submit"><i class="fa fa-arrow-alt-circle-down"></i> Mettre à jour</button>
  <?php 
  ...
  ?>
   <button name="off" style="background:red" type="submit"><i class="fa fa-power-off"></i> Indisponible</button>
 <?php } else { ?>
   <button name="on" style="background:#ff8900" type="submit"><i class="fa fa-circle-notch"></i> Disponible</button>
 <?php } ?>
    </form>
   </div>
 <footer>
