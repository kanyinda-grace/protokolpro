...
?>
        ...
        <div class="bloc-content">
            <ul>
                ...
                <li><i class="fa fa-envelope"></i><a href="courrier_entrant.php"> Enregistrer Courrier sortant</a></li>
                <li><i class="fa fa-bars"></i><a href="listcorrier.php"> Liste des courriers</a> <span class="ntf-outs"><?php echo $c; ?></span> </li>
                <li><i class="fa fa-archive"></i><a href="archivage.php"> Les archives</a></li>
                <li style="box-shadow:none"><i class="fa fa-archive"></i><a href="QR/jeton.php"> Créer un jéton</a></li>
            </ul>
