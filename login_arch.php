  ...
  <div class="row h-100 justify-content-center align-items-center">
    ...
    if(isset($message)){
     ...
     <div class="form-row justify-content-center" >
      ...
      <div class="form-row justify-content-center">
         <div class="col-7  my-1">
             <button type="submit" name="submit" class="btn btn-info btn-block" style="background-color: #00BFFF; color: #fff;font-size:23px;width:50x%;font-family:verdana">Se Connecter</button>
         </div>
      </div>
     </div> </br></br>
