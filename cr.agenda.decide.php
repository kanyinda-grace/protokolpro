...
<br>
<span class="title-msg">Créer Mon Agenda</span>
       <br><br>
      <div>
    ...
    <select name="heure_dim_c">
     ...
     <option> <?php echo $min; ?> </option> <?php } ?>
      ...
      <br><br>
      <button style="margin-left:0px" name="maj" type="submit"><i class="fa fa-arrow-alt-circle-down"></i> Créer mon agenda</button>
    </form>
       </div>
 </div>
</body>
