...
<body>
    ...
    <div class="bloc-login">
        <div class="bloc-txt">
                <br><br>
                <span class="title-msg">Rapport Journalier des audiances</span>
            <br><br><br>
            <form method="get">
            ...
            <?php
                   ...
                   if(isset($jour)) {
                    ...
                    $a=$bdd->prepare("SELECT * FROM archive_audiance WHERE jour_audiance_archive=? AND mois_audiance_archive=? AND annee_audiance_archive=?");
