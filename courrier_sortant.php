<?php include("base.php");
  ...
  extract($_POST);
        ...
        $ps=$bdd->prepare("INSERT INTO courrier_entrant(objet_courrier_entrant,jour_courrier_entrant,heur_courrier_entrant,minute_courrier_entrant,annee_courrier_entrant,mois_courrier_entrant,id_service,id_agent,id_correspondant
            ,observation_courrier_entrant) VALUES (?,?,?,?,?,?,?,?,?,?)") or die("erreur dans le insert");
        $param=array($objet_courrier_entrant,$jour_courrier_entrant,$heur_courrier_entrant, $minute_courrier_entrant,$annee_courrier_entrant,$mois_courrier_entrant,$id_service,$id_agent,$id_correspondant,$observation_courrier_entrant) or die("erreur param");
    ...
    <div class="bloc-login">
        ...
        <div class="bloc-txt">
            <form action="" method="post">
                ...
                <br><input style="margin-top:30px" type="text" name="objet_courrier_entrant" placeholder="Objet...">
          ...
          echo '<option value = "'.$fonct['id_service'].'">'.$fonct['libele_service'].'</option>';
                ...
                <br><label for="select">Agent :</label>
                <select style="margin-left:70px" name="id_agent">
                    <?php
                 $service = $bdd->query("SELECT * FROM agent ");
            
                 while($fonct=$service->fetch()){
                
          echo '<option value = "'.$fonct['id_agent'].'">'.$fonct['nom_agent'].'</option>';
