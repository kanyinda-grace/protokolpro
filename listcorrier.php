...
?>
 ...
 <ul>
  ...
  <?php if($inf["vue_courrier_entrant"] == 0) { ?>
  <a href="update.php?update=<?php echo $inf["id_courrier_entrant"] ?>">
  <button type="button">Accusé la reception</button>
  </a>
  <?php } else { ?>
  <button type="button" style="background:#818181"><i class="fa fa-check-circle"></i> Courrier Accusé</button>
  <?php } ?>
 </ul>
 </form>
 <hr style="width: 90%;">
